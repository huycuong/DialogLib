...
public abstract class AwesomeDialogBuilder<T extends AwesomeDialogBuilder> {
    ...
    private TextView tvMessage, tvAdditional;
    ...
    public void createDialog(AlertDialog.Builder dialogBuilder) {
        ...
        tvAdditional = findView(R.id.dialog_additional_info);
    }
    ...
    public T setAdditionalInfo(CharSequence title) {
        if (tvAdditional != null) {
            tvAdditional.setText(title);
